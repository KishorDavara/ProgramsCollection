...
class adjNode2 {
    ...
    public adjNode2(int source, int destination) {
        this.source = source;
...
class Graph4 {
    ...
    public void addEdge(int source, int destination) {
        ...
        adjNode2 adn = new adjNode2(source, destination);
    ...
    public void printAdjacencyList(Graph4 gph) {
        int vertex = gph.V;
        adjNode2 ad;
    ...
    public Graph4 getAdjacencyList(Graph4 gph) {
    ...
    public int[][] buildAdjacencyMatrix(Graph4 G) {
        int vertex = G.V;
